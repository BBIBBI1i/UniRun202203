...
public class Platform : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        // Start() 메서드처럼 컴포넌트가 활성화될 때 자동으로 한 번 실행되는 메서드 입니다.
        // 그런데, 처음 한 번만 실행되는 Start() 메서드와 달리 OnEnable()메서드는 컴포넌트가
        // 활성화될 때 마다 매번 다시 실행되는 메서드라서, 컴포넌트를 끄고 다시 켜는 방식으로
        // 재실행할 수 있는 메서드 입니다
